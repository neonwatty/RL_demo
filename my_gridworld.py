...
class my_gridworld():
    ...
    def qlearn(self,gamma):
        ...
        for n in range(num_episodes):
            ...
            while obstical_free == 0:
                loc = [np.random.randint(5),np.random.randint(5)]
            ...
            while steps < max_steps and loc != self.goal:    
                ...
                if loc2[0] > self.grid.height-1 or loc2[0] < 0 or loc2[1] > self.grid.width-1 or loc2[1] < 0 or loc2 in self.obstacles:
                    # don't move location
    ...
    def animate_movement(self,loc):
        ...
        if loc in self.obstacles or loc == self.goal or loc[0] > self.grid.width-1 or loc[0] < 0 or loc[1] > self.grid.height or loc[1] < 0:
